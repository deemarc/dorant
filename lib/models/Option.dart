...
class Option extends Model {
  ...
  const Option._internal({required this.id, title, createdAt, updatedAt}): _title = title, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Option({String? id, String? title}) {
  ...
  Option copyWith({String? id, String? title}) {
    return Option._internal(
      id: id ?? this.id,
  ...
  Map<String, Object?> toMap() => {
    'id': id, 'title': _title, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
